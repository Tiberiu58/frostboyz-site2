        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 border border-gray-800 rounded-lg">
              <h3 className="font-bold text-xl mb-3">Music Videos</h3>
              <p className="text-gray-400">
                Featured in 15+ music videos by emerging trap artists
              </p>
            </div>
            <div className="p-6 border border-gray-800 rounded-lg">
              <h3 className="font-bold text-xl mb-3">Influencer Collabs</h3>
              <p className="text-gray-400">
                Worn by 100+ social media influencers and content creators
              </p>
            </div>
            <div className="p-6 border border-gray-800 rounded-lg">
              <h3 className="font-bold text-xl mb-3">Street Style</h3>
              <p className="text-gray-400">
                Spotted in streetwear blogs and urban fashion magazines
              </p>
            </div>
          </div>
        </div>
