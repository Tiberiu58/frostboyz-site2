...
export const products: Product[] = [
  {
    ...
    features: ['Complete Set (Bracelet + Chain)', 'Hypoallergenic', 'Water-resistant', 'Premium Quality', 'Lifetime Warranty'],
    inStock: true,
  ...
  },
  {
    ...
    features: ['Adjustable Size', 'Hypoallergenic', 'Water-resistant', 'Premium Quality', 'Lifetime Warranty'],
    inStock: true,
  ...
  },
  {
    ...
    features: ['Multiple Length Options', 'Hypoallergenic', 'Water-resistant', 'Premium Quality', 'Lifetime Warranty'],
    inStock: true,
